                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_1()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <p>{{ campaign.name }}</p>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                <h4 class="float-left">Email accounts that you're sending with in this
                                                    campaign</h4>
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_2()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <p v-for="email in campaign.accounts">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="../../../../assets/img/checkbox.png" alt="" width="20"
                                                        height="20">
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_3()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <tr class="text-muted small"
                                                        ...
                                                        <td width="30%" class="text-right">
                                                            <span v-if="option.note" class="mr-2 text-primary">{{
                                                                option.note }}</span>
                                                            <div class="switch">
                                                                <input type="checkbox" :id="'switches' + index"
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_4()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <span v-if="campaign.list">
                                                    {{ campaign.list.name }}
                                                    <router-link :to="ROUTE_USER_LISTS_SHOW(campaign.list_id)">
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_6()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col text-center" v-for="day in week_days" :key="day">
                                                        <p class="week-days text-capitalize border w2-step-4"
                                                            ...
                                                            {{ day }}
                                                            <span v-if="campaign?.days?.includes(day)"
                                                                class="check-mark"><i
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_7()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <FormControlSelect2 :disabled="true" readonly :col_md="6"
                                                    :options="timezones" v-model="campaign.timezone" label="" />
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                <h4 class="float-left">At what time?</h4>
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_8()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div v-for="option in scheduleOptions" :key="option.key"
                                                        class="col-md-6 mb-4">
                                                        <div class="border p-3 w2-step-4"
                                                            ...
                                                            <div class="p-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col border p-3 text-center pt-4">
                                                                        <h6>End</h6>
                                                                        <p v-if="option.key !== 'custom'">{{ option.end
                                                                            }}</p>
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom mb-3">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_9()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>

                                            <div v-for="account in email_accounts" :key="account.id"
                                                class="card mx-3 my-1">
                                                <div class="card-body " v-if="campaign?.accounts?.includes(account.id)">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <VueSlider v-model="account.per_minute" :min="0" disabled
                                                            :max="40" :tooltip="'always'" />
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Volume</label>
                                                        <VueSlider v-model="account.volume" :min="0" disabled
                                                            :max="40" />
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body border-bottom">
                                                ...
                                                <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_10()"
                                                    class="float-right btn btn-outline-primary"><i
                                                        class="pi pi-pencil"></i> Edit</router-link>
                                            </div>
                                            <div class="card-body">
                                                <div class="card message-body">
                                                    ...
                                                    <div class="card-body">
                                                        <h6 v-html="campaign.template.body" v-if="campaign.template"></h6>
                                                        ...
                                                        <div class="row justify-content-end">
                                                            <div class="col-md-4" v-if="campaign.template && campaign.template.signature">
                                                                <span v-html="campaign.template.signature"></span>
                                                            </div>
                                                        </div>
                        ...
                        <div class="card-footer">
                            <router-link :to="ROUTE_USER_CAMPAIGNS_STEP_11()"
                                class="btn bg-white border shadow-2 px-3 float-left rounded-pill"> <i
                                    class="pi pi-arrow-left"></i> Back </router-link>
                            <button class="btn btn-primary border shadow-2 px-4 rounded-pill float-right"
                                @click="launchCampaign"> Launch <i class="mdi mdi-rocket"></i> </button>
                        </div>
                    </div>
...
import {
    ...
    ROUTE_USER_CAMPAIGNS_STEP_9, ROUTE_USER_LISTS_SHOW, SHEET_TYPE_CSV,
} from "../../../../constants.js";
...
export default {
    ...
    methods: {
        ...
        launchCampaign() {
            this.processing = true;
            this.axios.post('user/campaigns/launch', this.campaign).then((response) => {
